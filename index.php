    ...
    <div class="timeline">
      <div class="timeline-item right wow slideInLeft" data-wow-delay="0.1s">
        <div class="timeline-text">
          ...
          <h2>
            <a href="https://github.com/CodingWizardITER/Projects">Project Stack</a>
          </h2>
      ...
      <div class="timeline-item right wow slideInLeft" data-wow-delay="0.1s">
        <div class="timeline-text">
          <div class="timeline-date">2021 - Ongoing</div>
          <h2>
            <a href="https://github.com/CodingWizardITER/GUI">GUI Applications</a>
          </h2>
          <h4>ITER, SOA University</h4>
      ...
      <div class="timeline-item right wow slideInRight" data-wow-delay="0.1s">
        <div class="timeline-text">
          <div class="timeline-date">2021 - Ongoing</div>
          <h2>
            <a href="https://github.com/CodingWizardITER/Algorithms">Algorithms</a>
          </h2>
          <h4>ITER, SOA University</h4>
          <p>
      ...
      <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
        <div class="timeline-text">
          ...
          <h2>
            <a href="https://codingwizarditer.github.io/CoConjure/">CoConjure</a>
          </h2>
          <h4>ITER, SOA University</h4>
          <p>
